...
export const AdminTables = (props) => {
  ...
  const showDevices = () => {
    ...
    document.getElementById("firechiefsBtn").style.backgroundColor =
      "transparent";
  ...
  return (
    <PageContainer>
      ...
      <AdminButtons>
        ...
        <AdminBtn id="firechiefsBtn" onClick={showFirechiefs}>
          Firechiefs
        </AdminBtn>
      </AdminButtons>
      <Table style={{ marginTop: "0px" }}>
        <thead>
          <tr>
            ...
            {!renderDevices && (
              <td style={{ width: "25%" }}>Controllable Firezones</td>
            )}
