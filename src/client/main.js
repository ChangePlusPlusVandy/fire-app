  ...
  return (
    <BrowserRouter>
      <MainContainer>
        ...
        <Route path="/homeuser-register" component={HomeuserRegister} />

        <Route path="/owner-update" component={OwnerUpdate} />
        ...
        <Route path="/chief-register" component={ChiefRegister} />
        ...
        <Route path="/devices/startzone/:firezone" />
